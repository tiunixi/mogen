	...
	<view class="sunui-uploader-bd">
		<view class="sunui-uploader-files">
			...
			<view v-show="upload_before_list.length<upload_count" hover-class="sunui-uploader-hover" class="sunui-uploader-inputbox"
			 @click="chooseImage" :style="upload_img_wh"><!--  :style="upload_img_wh" -->
				<view>
					<text class="iconfont icon-mn_shangchuantupian" style="color: #666;"></text>
				</view>
			</view>
			<button v-show="!(upload_before_list.length<upload_count)" class="mini-btn up" type="default" size="mini">确定上传</button>
		</view>
	</view>
</template>
